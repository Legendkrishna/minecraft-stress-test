...
public class MinecraftStressTest {
    ...
    private static final String ADDRESS = System.getProperty("bot.ip", "ambrat12.aternos.me");
    private static final int PORT = Integer.parseInt(System.getProperty("bot.port", "38469"));
    ...
    public static final String DEFAULT_BOT_COUNT = "50";
